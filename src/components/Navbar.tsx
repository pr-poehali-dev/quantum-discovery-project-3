    ...
    <>
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-semibold text-lg">АкваСпорт</span>
          </div>
        </a>
        ...
        <div className="absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 text-sm font-medium text-white/70 transition duration-200 hover:text-white md:flex md:space-x-2">
          <a className="relative px-4 py-2 text-white/70 hover:text-white transition-colors cursor-pointer" href="#program">
            <span className="relative z-20">Программа</span>
          </a>
          <a className="relative px-4 py-2 text-white/70 hover:text-white transition-colors cursor-pointer" href="#nutrition">
            <span className="relative z-20">Питание</span>
          </a>
          <a className="relative px-4 py-2 text-white/70 hover:text-white transition-colors cursor-pointer" href="#excursions">
            <span className="relative z-20">Экскурсии</span>
          </a>
        ...
        <div className="flex items-center gap-3">
          <a
            href="#contacts"
            className="rounded-lg font-medium relative cursor-pointer hover:-translate-y-0.5 transition-all duration-200 inline-block text-center px-4 py-2 text-sm border bg-gradient-to-r from-cyan-500 to-blue-600 border-cyan-400/30 text-white hover:from-cyan-400 hover:to-blue-500"
          >
            Забронировать место
          </a>
        </div>
      ...
      >
        <a className="flex items-center justify-center gap-2" href="/">
          ...
          <span className="text-white font-semibold">АкваСпорт</span>
        </a>
            ...
            <nav className="flex flex-col space-y-4">
              ...
              <div className="border-t border-white/20 pt-4 mt-4 flex flex-col space-y-3">
                <a
                  href="#contacts"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="px-4 py-3 text-lg font-bold text-center rounded-lg transition-all duration-200 border bg-gradient-to-r from-cyan-500 to-blue-600 border-cyan-400/30 text-white"
                >
                  Забронировать место
                </a>
              </div>
